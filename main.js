...
// random generates no from 0-1 which is converted to string of  36 char(a-z & 0-9) and then a portion of string is extracted giving us a 13-character substring.
...
//show all todos using for each loop
